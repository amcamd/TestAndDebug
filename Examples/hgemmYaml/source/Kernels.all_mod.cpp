...
#pragma clang diagnostic pop
    ...
    /* local read b */
    b00[0]               = localReadB[0*SG1J*VECTOR_WIDTH + 0];
    b00[1]               = localReadB[0*SG1J*VECTOR_WIDTH + 0];
    b11[0]               = localReadB[0*SG1J*VECTOR_WIDTH + 1];
    b11[1]               = localReadB[0*SG1J*VECTOR_WIDTH + 1];
    b22[0]               = localReadB[0*SG1J*VECTOR_WIDTH + 2];
    b22[1]               = localReadB[0*SG1J*VECTOR_WIDTH + 2];
    b33[0]               = localReadB[0*SG1J*VECTOR_WIDTH + 3];
    b33[1]               = localReadB[0*SG1J*VECTOR_WIDTH + 3];
